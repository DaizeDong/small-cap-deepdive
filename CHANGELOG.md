...
- **No durable alpha.** The cheapness (Margin-of-Safety) signal beats IWM in-sample but is a
  2020 to 21 post-COVID-recovery regime artifact, it vanishes on the 2023 to 24 holdout (permutation
...
Phase 2 to 7 buildout on top of the v0.1.0 architecture. Remains a de-risk scanner:
...
- `judgment-rubric.md`, 7-dimension scorecard, evidence tier definitions (T1 to T3), hard
