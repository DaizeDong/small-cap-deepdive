...
**No, the trigger is alive and correctly conservative, but every BUY it produced is a false positive with a structural cause. Confirmed: 0 clean 30 to 60% BUY survived adversarial review.**
...
- **deathcare (E_deathcare): over-recall ~85 to 88%, keep-tier precision 8%, review-tier precision 10%.** Funeral/cremation/cemetery has no dedicated SIC, so non-excluded codes (pulp, airlines, food, beverages, mining) default to `keep` and pass Gate 1 untouched. **29 of 34 candidates are misrecalls.**
...
| deathcare | ~85 to 88% | 8% | 10% | MATW (real bug) |
...
| ABR | C cluster2 | 105% | nav | none | Commercial mortgage REIT priced at ~31 to 39% of tangible book; NAV-of-an-mREIT is mark-to-model, not liquidation value; financial-structure mismatch |
