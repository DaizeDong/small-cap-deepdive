...
> replay over a **2020 to 2024 panel**. Answers the campaign's deepest open question: *the skill is
...
## Panel (user: multi-date 2020 to 2024)
...
- **Cost**: comparable to the coverage test, ~10 to 15M tokens / ~15 to 25h, background + resumable.
