...
| Watch-band (2.0B to 5.0B, surfaced only) | 8 | NTB, APAM, SPNT, FG, SLG, AAMI, LAZ, AB, not deep-dived by design |
...
(a) the buy_eligible names that *do* have a usable NAV-MoS are all negative by 21 to 74%, there is no
