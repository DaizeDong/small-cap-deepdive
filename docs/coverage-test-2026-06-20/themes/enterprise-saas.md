...
Watch-band (band="watch", $2.0–5.0B; theme-fit only, no deep-dive): 17 names incl. AVPT, RAMP,
...
revenue multiples (EV/Sales 1–4x typical, EV/EBITDA 15–158x where EBITDA is even positive) precisely
...
- **Watch-band exclusion of true pure-plays:** many of the cleanest enterprise-SaaS pure-plays
  (WK, RNG, ZETA, NICE, QLYS, AVPT, RAMP) sit at $2.2–5.0B and are size-excluded from deep-dive by
