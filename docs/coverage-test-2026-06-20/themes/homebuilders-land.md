...
Watch band (theme-fit only, NOT deep-dived, $2–5B): GRBK, MHO, KBH, JOE, HHH, SKY, MRP, TPH are
...
- market-intel (`/c/Users/dzdon/CodesSelf/market-intel`) has no homebuilder-specific dataset (generic
  source catalog only).
- Qualitative cycle context (T2, public-domain, advisory only): US homebuilders entered 2026 trading
  at low-but-not-distressed P/B after the 2023–24 rate-driven affordability squeeze; entry-level
