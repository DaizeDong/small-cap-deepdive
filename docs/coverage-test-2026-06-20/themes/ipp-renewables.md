...
| Watch-band (2.0B–5.0B, surfaced only) | 21 | not deep-dived by design |
...
- **Qualitative macro (analyst knowledge, T2, non-load-bearing):** the IPP/renewables small-cap cohort
  through 2025–26 has been a *capital-cost-rate story* — utility-scale solar/storage economics are
