...
- **Qualitative T2 (analyst knowledge, labeled non-T1, NOT in the decision path):** The freight cycle in 2025–26 has been in a prolonged downturn ("freight recession") — soft truckload rates pressured asset-heavy carriers (CVLG, ULH) and asset-light forwarders alike (FWRD's restructuring post-Omni merger; RLGT's organic softness). Drybulk (PANL) rode a 2024 fleet-expansion / rate spike that the model flagged as peak-contaminated. This macro context is consistent with the mechanical output — depressed/cyclical earnings, premiums to NAV on the asset-light names, and no clean ≥30% MoS — but it is context only and was firewalled out of every eligibility decision.
