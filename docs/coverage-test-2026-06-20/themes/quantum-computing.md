...
| Small-cap cheap-pass input | 143 | after market-cap band tag (deep ≤ $2.0B; watch $2.0 to 5.0B) |
...
| Watch band (band="watch", $2.0 to 5.0B) | 16 | surfaced for human review only, not deep-dived (incl. **QUBT**, a true quantum pure-play, $2.4B) |
...
but sits in the $2.0 to 5.0B watch band, correctly above the deep-dive ceiling. A human reviewing this theme should look at QUBT,
...
elevated through 2025 to 2026 on the back of hardware-milestone announcements (IBM/Google error-correction claims) and a retail
