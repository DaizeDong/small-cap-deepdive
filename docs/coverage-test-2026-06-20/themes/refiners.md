...
The 14 watch-band names (DK, CVI, SUNC, PARR, CLMT etc. — the actual mid-cap refiners at $2.5–5B) sit
...
- **Adversarial verdict — NOT an opportunity; genuinely expensive on conservative FCF cap.** ARKO is
  ...
  FCF at 9–12% against the lease-laden capital structure leaves little for equity. Not a data artifact;
...
| **cyclical / thin-margin routing** (focus) | ✅ | fcf_cap chosen for APC/ARKO/CAPL; cap-rate 9–12% on normalized cyclical FCF |
...
- Refining/fuel-distribution is a **thin-margin cyclical**: crack spreads and fuel margins are the swing
  variable, and 2025–26 has been a normalizing (down) margin year off the 2022–23 peak. This is *consistent*
