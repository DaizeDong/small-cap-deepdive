...
- **Discovery FTS + market-cap fallback band split** (deep<$2B / watch $2 to 5B), fired; 67/10 split.
...
- The sector enters 2026 with "measured optimism", US restaurant sales ~$1.55T, modest real growth,
  but **margin pressure from beef inflation (+9.4%) and flat-to-low (0 to 1%) same-store sales** (RBC).
