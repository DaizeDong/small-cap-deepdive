...
| After mktcap/listing resolution | 200 priced; 87 deep (<\$2.0B) + 17 watch (\$2.0–5.0B) | yfinance; several delisted tickers dropped (IVAC, INFN, LAZRQ, ALTR, ANSS, etc.) |
