...
- **GHM**: MoS **-96.7%** (fcf_cap). Conservative 5yr-trailing-avg normalized FCF = $5.95M (the
  window includes the FY21–22 acquisition-integration trough with negative OCF), capitalized at
  9–12% → equity band $43–60M vs $1,295M market cap. ~100x P/E. No artifact — the cyclical
  normalizer is deliberately refusing to extrapolate the recent $24–28M OCF peak.
...
- **KVHI**: NAV MoS **-45.8%**; $188M cap vs $102–134M tangible-NAV band (~1.5x tangible book).
