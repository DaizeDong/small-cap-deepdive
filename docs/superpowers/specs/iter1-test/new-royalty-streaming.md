...
| 6–18 | ELE, GROY, MTA, TMCR, UROY, VOXR (gold/metals royalty); NRT, PBT, SBR, PVL, PRT (oil royalty trusts); MSB (iron-ore trust); VMET (metals royalty) | | pure | $28M–$1,307M | fcf_cap (null FCF) / abstain | — | mixed | 观察 |
...
- Revenue genuinely **growing**: 337→392→331→310→359→**411M** (rev_slope +1, rev_accel **+1**),
  OCF stable ~$190–200M, EV/EBITDA **3.4x**, EV/Sales 3.2x — cheap on the cash-generative royalty core.
...
- The MoS rests on `norm_fcf = $223M` (trailing-5yr avg). **`contamination_ratio = 0.7445`** and
  **`latest_below_avg = true`** — the normalization base is propped up by the 2022–2023 coal-price
...
2019–2024 is upward (it is recovering off the 2020 COVID coal trough of $120M). The single positive
