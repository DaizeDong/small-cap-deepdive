...
| Band split | deep=220 (≤$2.0B), watch=69 ($2.0–5.0B) | watch-band surfaced, **not** deep-dived per band guard |
...
The two real, profitable picks-and-shovels names (BWMN, LMB) are quality businesses growing 15–25%
with positive OCF — and the market already pays 14–15x EV/EBITDA and prices in ~7% perpetual growth
...
| BWMN/LMB/LTRX/SLNG | +1 | 0.9–2.1 | False | mixed | false | ✓ |
...
- **Watchlist (re-underwrite on a 30–40% pullback): BWMN and LMB.** These are the only two real,
  profitable, growing picks-and-shovels businesses in the universe — engineering/MEP firms with
  genuine hyperscale/mission-critical exposure, clean kill-flag sheets, positive OCF. At 14–15x
  EV/EBITDA they are priced for ~7% perpetual growth; if the recent attention rollover (T2) drags the
  multiple toward ~9–10x EV/EBITDA, the MoS math flips and they become real BUY candidates. **The
