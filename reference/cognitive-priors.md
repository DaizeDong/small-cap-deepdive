...
A deep-dive of 20 to 50 companies over a 3 to 5 year holding period cannot be back-tested. There is no historical analog. You cannot distinguish skill from luck statistically at this sample size.
...
**The honest position:** Until a substantial track-forward record exists (minimum 30 to 50 verdicts across multiple market cycles), treat all ratings as structured hypotheses, not alpha signals.
